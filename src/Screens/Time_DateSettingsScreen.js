...
function Time_DateSettingsScreen({navigation}) {
        ...
        <Box flex={1} bg={Colors.dark_gray}>
            <ScrollView>
                <Box flex={1} gap="4" padding="3" >
                    <Button onPress={() => navigation.navigate('Date')} shadow={5} _pressed={{backgroundColor: "gray.500"}} bg="#342F2Fee" justifyContent="flex-start" paddingLeft="10">
                        <Text color={Colors.white} fontSize="lg">Date Format</Text>
                        <Text color={Colors.gray} fontSize="xs">{date}</Text>
                    </Button>

                    <Button onPress={() => navigation.navigate('Time')} shadow={5} _pressed={{backgroundColor: "gray.500"}} bg="#342F2Fee" justifyContent="flex-start" paddingLeft="10">
